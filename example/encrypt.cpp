...
int main(int argc, char **argv) {
  ...
  // parser.add("-r", "resolution", "resolution of the resulting video",
  // "1080"); parser.add("--resolution", "resolution", "resolution of the
  // resulting video",
  //            "1080");
  // parser.parse(argc, argv);

  yt::Encrypter encrypter("LICENSE");
  encrypter.dump("LICENSE2");
